...
public class CheckList6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextStep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isChecked)
                {
                    Intent intent = new Intent(CheckList6.this,CheckList7.class);
                    startActivity(intent);
                }else
                {
                    Toast.makeText(CheckList6.this, "Please finish the step", Toast.LENGTH_SHORT).show();
                }
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(CheckList6.this,CheckList5.class);
                startActivity(intent);
            }
        });
    }

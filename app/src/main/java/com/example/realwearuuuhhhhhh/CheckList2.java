    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextStep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isChecked)
                {
                    Intent intent = new Intent(CheckList2.this,CheckList3.class);
                    startActivity(intent);
                }else
                {
                    Toast.makeText(CheckList2.this, "Please finish the step", Toast.LENGTH_SHORT).show();
                }
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(CheckList2.this,CheckList.class);
                startActivity(intent);
            }
        });
    }
